...
expName = 'motorsequencepsyfinal'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Suhani Jain\\Downloads\\lab psy\\motor sequence\\motorsequencepsyfinal_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('motor sequence conditions.xlsx'), 
        seed=None, 
    )
    ...
    for thisTrial_2 in trials_2:
        ...
        trial2 = data.Routine(
            name='trial2',
            components=[fixation1, LINE1, LINE2, LINE3, LINE4, PROBE, key_resp_2],
        )
